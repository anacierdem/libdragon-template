...
static regType register_fromindex(__OSThreadContext *context, int index)
{
    ...
    case 32:
        reg.size = 4;
        reg.ptr = ((u32 *)&context->sr);
        return reg;
    case 33:
        reg.size = 8;
        reg.ptr = ((u64 *)&context->lo);
        return reg;
    case 34:
        reg.size = 8;
        reg.ptr = ((u64 *)&context->hi);
        return reg;
    case 35:
        reg.size = 4;
        reg.ptr = ((u32 *)&context->badvaddr);
        return reg;
    case 36:
        reg.size = 4;
        reg.ptr = ((u32 *)&context->cause);
        return reg;
    case 37:
        reg.size = 4;
        reg.ptr = ((u32 *)&context->pc);
        return reg;
    case 70:
        reg.size = 4;
        reg.ptr = ((u32 *)&context->fpcsr);
        return reg;
    default:
        if (index < 32)
        {
...
static regType register_fromindex(reg_block_t *context, int index)
{
    ...
    case 36:
        reg.size = 4;
        reg.ptr = ((u32 *)&context->cr);
        return reg;
    case 70:
        reg.size = 4;
        reg.ptr = ((u32 *)&context->fc31);
        return reg;
    default:
        if (index < 32)
        {
